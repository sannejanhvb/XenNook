 ...
 * This file demonstrates how to integrate Xennook with a web frontend
 */

// For React/Vue/Angular applications
export class XennookClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new XennookClient(provider, contractAddress);
